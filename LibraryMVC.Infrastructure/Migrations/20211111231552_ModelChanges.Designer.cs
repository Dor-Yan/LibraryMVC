...
namespace LibraryMVC.Infrastructure.Migrations
{
    ...
    [Migration("20211111231552_ModelChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.Book", b =>
                {
                    ...
                    b.Property<string>("DateOfEdition")
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.BookTag", b =>
                {
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.BookWriter", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.Reader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.Writer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.BookWriter", b =>
                {
                    ...
                    b.HasOne("LibraryMVC.Domain.Model.Writer", "Writer")
                        .WithMany("BookWriters")
